...
def main(seed, dataset_name, obj_detect_checkpoint_file, tracker_cfg,
    ...
    # print(f'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n\n'
    #       f'DATASET IN TRACK:'
    #       f'{dataset}\n'
    #       f'first sequence in dataset: {dataset[0]}'
    #       f'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n\n')
    ...
    for seq in dataset:
        ...
        # print(f'TRACK SEQ: {seq[0]}')
        # print(f'SEQUENCE: {type(seq)}')
